...
\headerbox{Graph idea}{name=graph,column=0,below=introduction}{
...
\headerbox{Future work}{name=conclusion,column=0,below=graph}{
\begin{description}
...
\headerbox{Data and results}{name=results1,span=2,column=1,below=methods}{ % To reduce this block to 1 column width, remove 'span=2'
...
\captionof{figure}{Tree of consensuses generated for Ebola}
\end{minipage}
\begin{minipage}{0.49\linewidth}
\centering
\includegraphics[width=0.8\linewidth]{mycoplasma_tree}
\captionof{figure}{Tree of consensuses generated for Mycoplasma}
\end{minipage}
\end{center}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{qrcode}
\end{center}
\end{minipage}
\end{center}
