...
from ...context import pPoagraph, ConstSymbolProvider, FastaProvider
...
class DAGMaf2PoagraphFakeFastaProviderTests(unittest.TestCase):
    ...
    class FakeFastaProvider(FastaProvider):
        def __init__(self):
            self.sources = {
                ...
                pSeq.SequenceID("seq1"): "ACTAGGT",
                pSeq.SequenceID("seq2"): "GGTCAGT",
                pSeq.SequenceID("seq3"): "",
                pSeq.SequenceID("seq4"): ""}

        def get_base(self, sequence_id: pSeq.SequenceID, i: int) -> pNode.Base:
            try:
                return pNode.Base(self.sources[sequence_id][i])
            except KeyError:
    ...
    def test_3_missing_two_sequences_middle(self):
        ...
        expected_nodes = [
            ...
            pNode.Node(node_id=nid(4), base=pNode.Base('A'), aligned_to=None),

            # missing seq2
            pNode.Node(node_id=nid(5), base=pNode.Base('G'), aligned_to=None),
            pNode.Node(node_id=nid(6), base=pNode.Base('T'), aligned_to=None),
    ...
    def test_6_missing_one_reverted_sequence_middle_minus1_1(self):
        ...
        expected_nodes = [
            ...
            # missing seq2, on edge (-1,1)
            pNode.Node(node_id=nid(4), base=pNode.Base('T'), aligned_to=None),
            pNode.Node(node_id=nid(5), base=pNode.Base('C'), aligned_to=None),
    ...
    def test_7_missing_one_reverted_sequence_middle_minus1_minus1(self):
        ...
        expected_nodes = [
            ...
            # missing seq2
            pNode.Node(node_id=nid(4), base=pNode.Base('C'), aligned_to=None),
