...
@ddt
class PangraphBuilderFromMafTest_HelpMethods(unittest.TestCase):

    @data(("PangraphBuilderFromMaf_Tests/files_fill_maf_gaps/test_1_missing_sequence_start.maf", 12))
    @unpack
    ...
    @data(("PangraphBuilderFromMaf_Tests/files_help_methods/test_1_parallel_blocks_1st_and_2nd_merge_into_3rd.maf", [0, 1]),
          ("PangraphBuilderFromMaf_Tests/files_help_methods/test_2_two_blocks_in_disconnected_graph.maf", [0, 1]),
          ("PangraphBuilderFromMaf_Tests/build_pangraph/test_0_simple.maf", [0]))
    @unpack
