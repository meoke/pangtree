...
@ddt
class PangraphBuilderFromMafTest_FillMafGaps(PangraphComparator):
    ...
    def setUpClass(cls):
        ...
        cls.seq_metadata = metadatareader.read(pathtools.get_file_content("PangraphBuilderFromMaf_Tests/seq_metadata.json"))
        cls.fasta_source = PangraphBuilderFromMafTest_FillMafGaps.FakeFastaSource()

    def test_1_missing_sequence_start(self):
        maf_path = "PangraphBuilderFromMaf_Tests/files_fill_maf_gaps/test_1_missing_sequence_start.maf"
        expected_nodes = [
    ...
    def test_2_missing_sequence_end(self):
        maf_path = "PangraphBuilderFromMaf_Tests/files_fill_maf_gaps/test_2_missing_sequence_end.maf"
        expected_nodes = [
    ...
    def test_3_missing_two_sequences_middle(self):
        maf_path = "PangraphBuilderFromMaf_Tests/files_fill_maf_gaps/test_3_missing_two_sequences_middle.maf"
        expected_nodes = [
            Node(id=0, base=n.code('A'), in_nodes=[], aligned_to=1),
            Node(id=1, base=n.code('G'), in_nodes=[], aligned_to=0),
    ...
    def test_4_missing_one_sequence_middle(self):
        maf_path = "PangraphBuilderFromMaf_Tests/files_fill_maf_gaps/test_4_missing_one_sequence_middle"
        expected_nodes = [
            Node(id=0, base=n.code('A'), in_nodes=[], aligned_to=1),
            Node(id=1, base=n.code('G'), in_nodes=[], aligned_to=0),
            Node(id=2, base=n.code('C'), in_nodes=[0], aligned_to=None),
