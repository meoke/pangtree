...
class MafReaderTests(unittest.TestCase):
    ...
    [Source(ID=0,
            name='source1',
            title='source1',
            nodes_IDs=np.array([2, 3, 4, 5, 7, 8, 9, 10, 11, 12, 13, 14, 15]),
            weight=0),
    Source(ID=1,
           name='source2',
           title='source2',
           nodes_IDs=np.array([0, 1, 3, 4, 6, 7, 8, 12, 13, 14, 16, 17]),
           weight=0)],
    [Consensus(ID=0, 
               name='CONSENS0', 
               title='consensus produced by heaviest_bundle, containing 1 seqs',
               nodes_IDs=np.array([0, 1, 3, 4, 5, 7, 8, 9, 10, 11, 12, 13, 14, 16, 17])),
    Consensus(ID=1, 
              name='CONSENS1', 
              title='consensus produced by heaviest_bundle, containing 1 seqs',
              nodes_IDs=np.array([2, 3, 4, 5, 7, 8, 9, 10, 11, 12, 13, 14, 15]))],
    ...
    Node(ID=17,base='M', in_nodes=np.array([16]), aligned_to=None)]),#, consensuses_count=1)]),
        ('4 nodes aligned',
         ['VERSION=NOVEMBER',
          'NAME=test',
          'TITLE=test_0',
         ...
         [Source(ID=0,
                 name='source1',
                 title='source1',
                 nodes_IDs=np.array([0]),
                 weight=0),
          Source(ID=1,
                 name='source2',
                 title='source2',
                 nodes_IDs=np.array([1]),
                 weight=0),
         Source(ID=2,
                name='source3',
                title='source3',
                nodes_IDs=np.array([2]),
                weight=0),
         Source(ID=3,
                name='source4',
                title='source4',
                nodes_IDs=np.array([3]),
                weight=0)],
         [],
         [Node(ID=0, base='T', in_nodes=np.array([]), aligned_to=1),#, consensuses_count=0),
          ...
          Node(ID=3, base='K', in_nodes=np.array([]), aligned_to=0)])#, consensuses_count=0)])
    )
    @unpack
