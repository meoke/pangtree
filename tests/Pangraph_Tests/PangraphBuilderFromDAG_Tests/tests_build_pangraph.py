...
class PangraphBuilderFromDAGTest_BuildPangraph(PangraphTests):
    ...
    def test_00_simple(self):
        ...
        expected_nodes = [
            ...
            Node(node_id=8, base=n('A'), aligned_to=None),
    ...
    def test_01_reversed_seq_in_one_block(self):
        ...
        expected_nodes = [
            ...
            Node(node_id=4, base=n('G'), aligned_to=5),
    ...
    def test_03_edge_not_from_last_node_in_block(self):
        ...
        expected_nodes = [
            ...
            Node(node_id=2, base=n('T'), aligned_to=None),
            Node(node_id=3, base=n('G'), aligned_to=None),
            Node(node_id=4, base=n('G'), aligned_to=None),
            Node(node_id=5, base=n('A'), aligned_to=6),
            Node(node_id=6, base=n('T'), aligned_to=5),
    ...
    def test_06_1st_block_separates_into_2_branches_which_connect_in_3rd_block(self):
        ...
        expected_nodes = [Node(node_id=0, base=n('A'), aligned_to=1),
                          ...
                          Node(node_id=2, base=n('G'), aligned_to=0),
                          Node(node_id=3, base=n('C'), aligned_to=None),
                          ...
                          Node(node_id=9, base=n('G'), aligned_to=10),
                          Node(node_id=10, base=n('T'), aligned_to=8)]
    ...
    def test_07_inactive_edges_due_to_reversed_seqs(self):
        ...
        expected_nodes = [
                            ...
                            Node(node_id=10, base=n('A'), aligned_to=None),
                            Node(node_id=11, base=n('A'), aligned_to=None),
                            Node(node_id=12, base=n('A'), aligned_to=13),
                            Node(node_id=13, base=n('C'), aligned_to=12),
                            Node(node_id=14, base=n('A'), aligned_to=15),
                            Node(node_id=15, base=n('T'), aligned_to=14),
        ]
    ...
    def test_08_reversed_block(self):
        ...
        expected_nodes = [
                            ...
                            Node(node_id=4, base=n('G'), aligned_to=None),
                            Node(node_id=5, base=n('A'), aligned_to=6),
                            Node(node_id=6, base=n('G'), aligned_to=5),
                            Node(node_id=7, base=n('A'), aligned_to=None),
    ...
    def test_09_inactive_edges_but_all_strands_plus(self):
        ...
        expected_nodes = [
            ...
            Node(node_id=6, base=n('C'), aligned_to=None),
            Node(node_id=7, base=n('T'), aligned_to=None),
            Node(node_id=8, base=n('G'), aligned_to=None),
            Node(node_id=9, base=n('G'), aligned_to=None),

            Node(node_id=10, base=n('A'), aligned_to=None),
            Node(node_id=11, base=n('C'), aligned_to=None),
            Node(node_id=12, base=n('T'), aligned_to=None),
            Node(node_id=13, base=n('G'), aligned_to=None),
            Node(node_id=14, base=n('G'), aligned_to=None),

            Node(node_id=15, base=n('A'), aligned_to=None),
            Node(node_id=16, base=n('C'), aligned_to=None),
            Node(node_id=17, base=n('T'), aligned_to=None),
            Node(node_id=18, base=n('G'), aligned_to=None),
            Node(node_id=19, base=n('G'), aligned_to=None)
        ]
        expected_paths = {
            "seq0": [],
    ...
    def test_10_parallel_blocks_1st_and_2nd_merge_into_3rd(self):
        ...
        expected_nodes = [
            Node(node_id=0, base=n('G'), aligned_to=1),
            ...
            Node(node_id=12, base=n('C'), aligned_to=13),
            Node(node_id=13, base=n('G'), aligned_to=12),
            Node(node_id=14, base=n('C'), aligned_to=15),
            Node(node_id=15, base=n('G'), aligned_to=16),
            Node(node_id=16, base=n('T'), aligned_to=14),
            Node(node_id=17, base=n('A'), aligned_to=18),
            Node(node_id=18, base=n('T'), aligned_to=17),
            Node(node_id=19, base=n('A'), aligned_to=20),
            Node(node_id=20, base=n('C'), aligned_to=19),
            Node(node_id=21, base=n('C'), aligned_to=22),
            Node(node_id=22, base=n('G'), aligned_to=21)
        ]
